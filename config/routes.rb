...
post 'asignacions/revisar', :to => 'asignacions#revisar'
get 'asignacions/asignar', :to => 'asignacions#asignar'
post 'asignacions/asignar_iniciar', :to => 'asignacions#asignar_iniciar'
post 'asignacions/asignar_continuar', :to => 'asignacions#asignar_continuar'
...
post 'asignacionexas/revisar', :to => 'asignacionexas#revisar'
get 'asignacionexas/asignar', :to => 'asignacionexas#asignar'
post 'asignacionexas/asignar_iniciar', :to => 'asignacionexas#asignar_iniciar'
post 'asignacionexas/asignar_continuar', :to => 'asignacionexas#asignar_continuar'
post 'asignacionexas/grabar_asignacion', :to => 'asignacionexas#grabar_asignacion'
