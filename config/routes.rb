...
post 'solicitudlabexas/borrarSolicitudes', :to => 'solicitudlabexas#borrarSolicitudes'
...
post 'asignaciondefs/anadirListaExterna', :to => 'asignaciondefs#anadirListaExterna'
...
get 'asignaciondefs/grabar_asignacion', :to => 'asignaciondefs#grabar_asignacion'
get 'asignaciondefs/consulta', :to => 'asignaciondefs#consulta'
get 'asignaciondefs/asigna_directa', :to => 'asignaciondefs#asigna_directa'
post 'asignaciondefs/graba', :to => 'asignaciondefs#graba'
post 'asignacions/graba', :to => 'asignacions#graba'
post 'asignaciondefs/getAsignacion', :to => 'asignaciondefs#getAsignacion'
post 'asignacions/getAsignacion', :to => 'asignacions#getAsignacion'
post 'asignaciondefs/borradirasignada', :to => 'asignaciondefs#borradirasignada'
post 'asignacions/borranormal', :to => 'asignacions#borranormal'
post 'asignaciondefs/borranormalasignada', :to => 'asignaciondefs#borranormalasignada'
post 'asignaciondefs/actualizar', :to => 'asignaciondefs#actualizar'
post 'asignacions/actualizar', :to => 'asignacions#actualizar'
...
get 'listado/estadistica_lectivo_impresa', :to => 'listado#estadistica_lectivo_impresa'
get 'listado/estadistica_examenes_impresa', :to => 'listado#estadistica_examenes_impresa'
